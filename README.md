...
**NOTE:** This is a legacy version of transCSSR for use with Python 2.7. The most recent version of transCSSR for use with Python 3.7+ is hosted [here](https://github.com/ddarmon/transCSSR).